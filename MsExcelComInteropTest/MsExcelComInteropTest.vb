    ...
    Public Class Tests
        ...
        Private Shared Sub CheckForRunningMsExcelInstancesAndAskUserToKill()
            ...
            If MsExcelProcesses IsNot Nothing AndAlso MsExcelProcesses.Length > 0 Then
                ...
                Try
                    AllowedToKillProcesses = (MsgBox(MsExcelProcesses.Length & " bereits ge�ffenete MS Excel Instanzen wurden gefunden. Sollen diese zuvor geschlossen werden?", MsgBoxStyle.Question Or MsgBoxStyle.YesNo) = vbYes)
