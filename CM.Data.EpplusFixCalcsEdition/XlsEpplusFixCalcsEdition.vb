...
Namespace CompuMaster.Data
    ...
    Public Class XlsEpplusFixCalcsEdition
        ...
        ''' <remarks></remarks>
        Private Shared Sub SaveWorkbook(ByVal exportWorkbook As CompuMaster.Epplus4.ExcelPackage, ByVal outputPath As String)
        ...
        Private Shared Function OpenAndWriteDataTableToXlsFile(ByVal inputPath As String, ByVal dataTables As System.Data.DataTable(), ByVal sheetnames As String(), ByVal specialSheet As SpecialSheet) As CompuMaster.Epplus4.ExcelPackage
            ...
            Else
                exportWorkbook = New CompuMaster.Epplus4.ExcelPackage
            End If
        ...
        Private Shared Function LoadWorkbookFile(inputPath As String) As CompuMaster.Epplus4.ExcelPackage
...
#Region "Internal tools"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Shared Function LookupLastContentColumnIndex(ByVal sheet As CompuMaster.Epplus4.ExcelWorksheet) As Integer
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Shared Function LookupLastContentRowIndex(ByVal sheet As CompuMaster.Epplus4.ExcelWorksheet) As Integer
            If sheet.Dimension Is Nothing Then Return 0
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Shared Function IsEmptyCell(ByVal sheet As CompuMaster.Epplus4.ExcelWorksheet, ByVal rowIndex As Integer, ByVal columnIndex As Integer) As Boolean
                    ...
                    Select Case LookupDotNetType(sheet.Cells(rowCounter + 1, colCounter + 1))
                        ...
                        Case VariantType.Error
                            If data.Columns(colCounter).DataType Is GetType(Double) Then
                                If CType(sheet.Cells(rowCounter + 1, colCounter + 1).Value, CompuMaster.Epplus4.ExcelErrorValue).ToString = CompuMaster.Epplus4.ExcelErrorValue.Values.Div0 Then
                                    value = Double.NaN
                                ElseIf CType(sheet.Cells(rowCounter + 1, colCounter + 1).Value, CompuMaster.Epplus4.ExcelErrorValue).ToString = CompuMaster.Epplus4.ExcelErrorValue.Values.Num Then
                                    value = Double.PositiveInfinity
                                Else
                                    value = DBNull.Value
                                End If
                            ElseIf data.Columns(colCounter).DataType Is GetType(String) Then
                                value = CType(sheet.Cells(rowCounter + 1, colCounter + 1).Value, CompuMaster.Epplus4.ExcelErrorValue).ToString
                            Else
                                value = DBNull.Value
                            End If
        ...
        Private Shared Function LookupDotNetType(xlsCell As CompuMaster.Epplus4.ExcelRange) As VariantType
            ...
            Else
                Select Case xlsCell.Value.GetType
                    ...
                    Case GetType(DateTime)
                        Return VariantType.Date
                    Case GetType(CompuMaster.Epplus4.ExcelErrorValue)
        ...
        ''' <remarks>
        ''' </remarks>
        Private Shared Function ReadDataTableFromXlsFileCreateDataTableSuggestion(ByVal sheet As CompuMaster.Epplus4.ExcelWorksheet, ByVal tableName As String, ByVal startReadingAtRowIndex As Integer, ByVal firstRowContainsColumnNames As Boolean) As DataTable
                ...
                For RowCounter As Integer = firstContentRowIndex To LastSheetContentRowIndex
                    Select Case LookupDotNetType(sheet.Cells(RowCounter + 1, colCounter + 1))
                        ...
                        Case VariantType.Error
                            ...
                            Select Case CType(sheet.Cells(RowCounter + 1, colCounter + 1).Value, CompuMaster.Epplus4.ExcelErrorValue).ToString
                                Case CompuMaster.Epplus4.ExcelErrorValue.Values.Div0, CompuMaster.Epplus4.ExcelErrorValue.Values.Num
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Shared Function CellValueAsString(ByVal cell As CompuMaster.Epplus4.ExcelRange) As String
            Try
                Return cell.Text
            Catch ex As Exception
