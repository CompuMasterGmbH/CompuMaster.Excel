...
Use Spire.Xls for solutions targetting .NET Framework 4.8 or .NET 6 or higher
...
workbook = new SpireXlsDataOperations(null, ExcelDataOperationsBase.OpenMode.CreateFile, new ExcelDataOperationsOptions());
