    ...
    Public Class MsExcelCalcTestFreeSpireXls
        ...
        Protected Overrides ReadOnly Property EngineName As String
            Get
                ...
                If Result Is Nothing Then Result = (New ExcelOps.FreeSpireXlsDataOperations(ExcelDataOperationsBase.OpenMode.Uninitialized)).EngineName
                Return Result
            End Get
        End Property
        ...
        Protected Overrides Function CreateEngineInstanceWithCreateFileMode(testFile As String) As ExcelOps.ExcelDataOperationsBase
            Return New ExcelOps.FreeSpireXlsDataOperations(testFile, ExcelOps.ExcelDataOperationsBase.OpenMode.CreateFile, New ExcelDataOperationsOptions(ExcelDataOperationsOptions.WriteProtectionMode.DefaultBehaviourOnCreateFile))
        End Function
